...
const adminController = {
    ...
    try {
      ...
      if (features && Array.isArray(features)) {
        for (const feature of features) {
          await query(productQueries.insertProductFeature, [productId, feature]);
        }
      }
  ...
  updateProduct: async (req, res) => {
    try {
      ...
      const result = await query(productQueries.updateProduct, [
        id,
        name,
        brand,
        price,
  ...
  getStats: async (req, res) => {
    try {
      ...
      const predictionStatsResult = await query(predictionQueries.getPredictionStats);
  ...
  retrainModel: async (req, res) => {
    try {
      ...
      const mlResponse = await axios.post(`${ML_API_URL}/retrain`, {
